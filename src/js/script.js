document.addEventListener('DOMContentLoaded', function () {
    ...
    copyUrlButton.addEventListener('click', function () {
        ...
        const endpoint = "https://virtuoso.cellar.development.op.aws.cloud.tech.ec.europa.eu/sparql";
    ...
    queryForm.addEventListener('submit', async function (event) {
        ...
        const endpoint = "https://virtuoso.cellar.development.op.aws.cloud.tech.ec.europa.eu/sparql"; // Correct endpoint
